...
from function import newtxt,newimagedata,create_plots,plot_confusion_matrix,cnn_model,cnn_model1,transfer_model
...
label = shuffle_label
x_train = crop_image[0:8000]
x_test = crop_image[8000:]

y_train_vector = label[0:8000]
y_test_vector = label[8000:]
#%%
